...
{
	DWORD m_iCompetitiveRanking = GET_NETVAR("DT_CSPlayerResource", "m_iCompetitiveRanking"); //NetVar.GetNetVar(0x75671F7F); //NetVar.GetNetVar(0x75671F7F);
	DWORD GameResources = *(DWORD*)(Utilities::Memory::FindPatternV2("client.dll", "8B 04 88 03 F0") + 0x2);
